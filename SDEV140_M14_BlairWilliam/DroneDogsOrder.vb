Public Class DroneDogsOrder
    ...
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ...
        'We must do error handling to ensure that the user only users 0 or non-negative numbers _
        '& while inputting quantities. _
        ...
        Catch ex As System.FormatException
            ' Show the exception's message.
            'MessageBox.Show(ex.Message)
            MessageBox.Show("PorkDog quantity encountered an error. Please start over and ensure " _
                            & "only 0 or non-negative numbers are in the quantity box.")
            btnClear_Click(sender, e)
            Exit Sub
            ' Show the stack trace, which is a list of methods
        ...
        Catch ex As System.FormatException
            ' Show the exception's message.
            'MessageBox.Show(ex.Message)
            MessageBox.Show("TurkeyDog quantity encountered an error. Please start over and ensure " _
                            & "only 0 or non-negative numbers are in the quantity box.")
            btnClear_Click(sender, e)
